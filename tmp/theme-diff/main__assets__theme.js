...
(() => {
    try {
      ...
      const isPortuguesePage = () => {
        ...
        return locale === 'pt' || locale === 'pt-pt' || window.location.pathname === '/pt' || window.location.pathname.startsWith('/pt/');
      };
...
/* pt-pt-runtime-hotfix-asset:end */
