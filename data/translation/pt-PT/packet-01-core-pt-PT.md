# Packet 01 — Core Storefront Translation (pt-PT)
...
### Hero block 1
- Meet Summer 2026!
  Conheça o verão 2026!
- Juicy berries, matcha tea breezes, sunlit florals, soft musks and bold green woods — the new summer collection captures everything this season is about: green nuance, quiet luxury and textured freshness. Every scent is crafted to shine in diffusers, candles, room sprays and soaps, so your whole summer line can feel cohesive, modern and truly premium.
  Bagas suculentas, brisas de chá matcha, florais banhados de sol, almíscares suaves e madeiras verdes marcantes — a nova coleção de verão reúne tudo o que esta estação representa: nuance verde, luxo discreto e frescura texturada. Cada fragrância foi criada para brilhar em difusores, velas, sprays de ambiente e sabonetes, para que toda a sua linha de verão se sinta coesa, moderna e verdadeiramente premium.
- Shop the collection
  Comprar a coleção

### Hero block 2
- Start your candle business right — no chaos, no guesswork.
  Lance o seu negócio de velas da forma certa — sem caos, sem adivinhas.
- Our kits are made for those who want to explore candle making and home fragrance as a business. Each one includes everything you need to create your first test batch, work with the right materials, and see the full process in action. It’s the most practical way to understand how it all works — and discover the real potential of your future collection.
  Os nossos kits foram criados para quem quer explorar o fabrico de velas e a perfumaria para a casa como negócio. Cada um inclui tudo o que precisa para criar o seu primeiro lote de teste, trabalhar com os materiais certos e ver todo o processo em ação. É a forma mais prática de perceber como tudo funciona — e de descobrir o verdadeiro potencial da sua futura coleção.
- Choose your kit
  Escolha o seu kit
...
- Explore our quality candle and diffuser-making products, carefully selected for their exceptional performance and reliability.
  Explore os nossos produtos para fabrico de velas e difusores, cuidadosamente escolhidos pela sua performance excecional e fiabilidade.
...
- Sign up to our newsletter and get the best deals!
  Subscreva a nossa newsletter e receba as melhores ofertas.
- E-mail
  E-mail
- Subscribe
  Subscrever
...
- diffuser making supplies
  materiais para fabrico de difusores
- room spray making supplies
  materiais para fabrico de sprays de ambiente
...
- candle jars and lids
  recipientes e tampas para velas
- diffuser bottles
  frascos para difusor
- room spray bottles
  frascos para spray de ambiente
- reeds
  varetas
- diffuser base
  base para difusor
...
- Products & Philosophy
  Produtos e filosofia
- Fragrance Development
  Desenvolvimento de fragrâncias
- Customer Care
  Apoio ao cliente

### Core copy
- We bring over a decade of expertise in producing candles, diffusers, and room sprays for private labels. Our customers receive exactly the same premium-quality ingredients that we use in our own collections — ensuring consistent, reliable, and professional results every time.
  Trazemos mais de uma década de experiência na produção de velas, difusores e sprays de ambiente para marcas próprias. Os nossos clientes recebem exatamente os mesmos ingredientes premium que utilizamos nas nossas próprias coleções, garantindo sempre resultados consistentes, fiáveis e profissionais.
...
- Excellent wax quality that delivers a beautiful candle surface and clean burn.
  Excelente qualidade de cera, que proporciona uma superfície bonita e uma combustão limpa.
- Long-lasting, carefully selected fragrances with no off-notes or unwanted undertones.
  Fragrâncias duradouras, cuidadosamente selecionadas, sem notas indesejadas nem nuances desagradáveis.
...
- Seasonal preferences for autumn–winter or spring–summer.
  Preferências sazonais para outono-inverno e primavera-verão.
- A balance between universal favourites and unique niche accords.
  Um equilíbrio entre favoritos universais e acordes de nicho únicos.
- Each fragrance undergoes a multi-step selection process to guarantee purity, balance, and authenticity — no compromises.
  Cada fragrância passa por um processo de seleção em várias etapas para garantir pureza, equilíbrio e autenticidade — sem compromissos.
